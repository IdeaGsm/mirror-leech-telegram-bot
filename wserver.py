...
async def homepage(request):
    ...
    return web.Response(text="<h1>👀See😋mirror-leech-telegram-bot😇 <a href='https://t.me/4gdrive_bot'>@🔰RedmiDrive🔰</a> By <a href='https://github.com/IdeaGsm'>Don😎</a></h1>", content_type="text/html")
